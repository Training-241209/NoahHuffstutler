...
export function RegisterForm()
{
    ...
    return (
        <div className="flex h-screen justify-between items-center bg-white-60 text-white">
            <h1 className="font-bold text-[50px] ml-32"></h1>
            <Card className="w-[350px] dark text-white shadow-lg mr-60">
                <CardHeader>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
